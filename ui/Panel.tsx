...
function AboutSection() {
  const { t } = useLanguage();
  return (
    <ModalSection title={t.about.title}>
...
function FormationsSection() {
  const { t } = useLanguage();
  return (
    <ModalSection title={t.formations.title}>
          ...
          <div key={i} className="degree-item">
            <div className="degree-header">
              ...
              <span className="degree-school">
                {degree.school} ·{' '}
                <span className="degree-location">{degree.location}</span>
              </span>
            </div>
...
function ExperiencesSection() {
  const { t } = useLanguage();
  return (
    <ModalSection title={t.experiences.title}>
        ...
        {t.experiences.jobs.map((job, i) => (
          <div key={i} className="degree-item">
            <div className="degree-header">
              ...
              <span className="degree-school">
                {job.company} ·{' '}
                <span className="degree-location">{job.location}</span>
              </span>
            </div>
...
function ProjectsSection() {
  const { t } = useLanguage();
  return (
    <ModalSection title={t.projects.title}>
...
function ContactSection() {
  const { t } = useLanguage();
  return (
    <ModalSection title={t.contact.title}>
