...
function drawMoth(ctx: CanvasRenderingContext2D, cx: number, cy: number, sz: number, color: string) {
  ctx.save()
  ctx.strokeStyle = color; ctx.fillStyle = color
  // Upper wings
  ctx.globalAlpha = 0.68
  ctx.beginPath(); ctx.moveTo(cx, cy)
  ctx.bezierCurveTo(cx - sz * 0.28, cy - sz * 0.62, cx - sz * 1.05, cy - sz * 0.52, cx - sz, cy + sz * 0.18)
  ctx.bezierCurveTo(cx - sz * 0.78, cy + sz * 0.38, cx - sz * 0.28, cy + sz * 0.1, cx, cy); ctx.fill()
  ctx.beginPath(); ctx.moveTo(cx, cy)
  ctx.bezierCurveTo(cx + sz * 0.28, cy - sz * 0.62, cx + sz * 1.05, cy - sz * 0.52, cx + sz, cy + sz * 0.18)
  ctx.bezierCurveTo(cx + sz * 0.78, cy + sz * 0.38, cx + sz * 0.28, cy + sz * 0.1, cx, cy); ctx.fill()
  // Lower wings
  ...
  ctx.beginPath(); ctx.moveTo(cx, cy)
  ctx.bezierCurveTo(cx - sz * 0.18, cy + sz * 0.22, cx - sz * 0.75, cy + sz * 0.12, cx - sz * 0.65, cy + sz * 0.62)
  ctx.bezierCurveTo(cx - sz * 0.45, cy + sz * 0.82, cx - sz * 0.1, cy + sz * 0.48, cx, cy); ctx.fill()
  ctx.beginPath(); ctx.moveTo(cx, cy)
  ctx.bezierCurveTo(cx + sz * 0.18, cy + sz * 0.22, cx + sz * 0.75, cy + sz * 0.12, cx + sz * 0.65, cy + sz * 0.62)
  ctx.bezierCurveTo(cx + sz * 0.45, cy + sz * 0.82, cx + sz * 0.1, cy + sz * 0.48, cx, cy); ctx.fill()
  // Wing veins
  ctx.globalAlpha = 0.45; ctx.lineWidth = 0.9
  ctx.beginPath(); ctx.moveTo(cx, cy); ctx.lineTo(cx - sz * 0.85, cy + sz * 0.1); ctx.stroke()
  ctx.beginPath(); ctx.moveTo(cx, cy); ctx.lineTo(cx + sz * 0.85, cy + sz * 0.1); ctx.stroke()
  // Eye spots on wings
  ctx.globalAlpha = 0.75; ctx.lineWidth = 1
  ctx.beginPath(); ctx.arc(cx - sz * 0.5, cy - sz * 0.08, sz * 0.13, 0, Math.PI * 2); ctx.stroke()
  ctx.beginPath(); ctx.arc(cx + sz * 0.5, cy - sz * 0.08, sz * 0.13, 0, Math.PI * 2); ctx.stroke()
  ctx.globalAlpha = 0.35; ctx.fillStyle = color
  ctx.beginPath(); ctx.arc(cx - sz * 0.5, cy - sz * 0.08, sz * 0.06, 0, Math.PI * 2); ctx.fill()
  ctx.beginPath(); ctx.arc(cx + sz * 0.5, cy - sz * 0.08, sz * 0.06, 0, Math.PI * 2); ctx.fill()
  // Body
  ctx.globalAlpha = 0.72; ctx.fillStyle = color
  ctx.beginPath(); ctx.ellipse(cx, cy + sz * 0.18, sz * 0.075, sz * 0.42, 0, 0, Math.PI * 2); ctx.fill()
  // Antennae
  ctx.globalAlpha = 0.6; ctx.lineWidth = 0.9
  ctx.beginPath(); ctx.moveTo(cx - sz * 0.05, cy - sz * 0.1)
  ctx.bezierCurveTo(cx - sz * 0.22, cy - sz * 0.52, cx - sz * 0.42, cy - sz * 0.6, cx - sz * 0.32, cy - sz * 0.82); ctx.stroke()
  ctx.beginPath(); ctx.moveTo(cx + sz * 0.05, cy - sz * 0.1)
  ctx.bezierCurveTo(cx + sz * 0.22, cy - sz * 0.52, cx + sz * 0.42, cy - sz * 0.6, cx + sz * 0.32, cy - sz * 0.82); ctx.stroke()
  ctx.globalAlpha = 0.7; ctx.fillStyle = color
  ctx.beginPath(); ctx.arc(cx - sz * 0.32, cy - sz * 0.82, sz * 0.05, 0, Math.PI * 2); ctx.fill()
  ctx.beginPath(); ctx.arc(cx + sz * 0.32, cy - sz * 0.82, sz * 0.05, 0, Math.PI * 2); ctx.fill()
  ctx.restore()
}

function drawOwl(ctx: CanvasRenderingContext2D, cx: number, cy: number, sz: number, color: string) {
  ctx.save()
  ctx.fillStyle = color; ctx.strokeStyle = color; ctx.lineWidth = 1.1; ctx.globalAlpha = 0.92
  // Body
  ctx.beginPath(); ctx.ellipse(cx, cy + sz * 0.12, sz * 0.32, sz * 0.48, 0, 0, Math.PI * 2); ctx.fill()
  // Head
  ctx.beginPath(); ctx.arc(cx, cy - sz * 0.32, sz * 0.27, 0, Math.PI * 2); ctx.fill()
  // Ear tufts
  ctx.beginPath(); ctx.moveTo(cx - sz * 0.18, cy - sz * 0.52); ctx.lineTo(cx - sz * 0.1, cy - sz * 0.66); ctx.lineTo(cx - sz * 0.03, cy - sz * 0.53); ctx.fill()
  ctx.beginPath(); ctx.moveTo(cx + sz * 0.18, cy - sz * 0.52); ctx.lineTo(cx + sz * 0.1, cy - sz * 0.66); ctx.lineTo(cx + sz * 0.03, cy - sz * 0.53); ctx.fill()
  // Face disc
  ctx.strokeStyle = `${color}80`; ctx.lineWidth = 0.8
  ctx.beginPath(); ctx.arc(cx, cy - sz * 0.32, sz * 0.2, 0, Math.PI * 2); ctx.stroke()
  // Eyes
  ctx.fillStyle = '#0a0810'; ctx.globalAlpha = 0.9
  ctx.beginPath(); ctx.arc(cx - sz * 0.1, cy - sz * 0.35, sz * 0.08, 0, Math.PI * 2); ctx.fill()
  ctx.beginPath(); ctx.arc(cx + sz * 0.1, cy - sz * 0.35, sz * 0.08, 0, Math.PI * 2); ctx.fill()
  ctx.save(); ctx.shadowColor = '#fffab0'; ctx.shadowBlur = 8
  ctx.fillStyle = '#fffab0'; ctx.globalAlpha = 0.9
  ctx.beginPath(); ctx.arc(cx - sz * 0.1, cy - sz * 0.35, sz * 0.05, 0, Math.PI * 2); ctx.fill()
  ctx.beginPath(); ctx.arc(cx + sz * 0.1, cy - sz * 0.35, sz * 0.05, 0, Math.PI * 2); ctx.fill()
  ctx.restore()
  // Beak
  ctx.fillStyle = '#c8a060'; ctx.globalAlpha = 0.8
  ctx.beginPath(); ctx.moveTo(cx - sz * 0.05, cy - sz * 0.25); ctx.lineTo(cx, cy - sz * 0.18); ctx.lineTo(cx + sz * 0.05, cy - sz * 0.25); ctx.closePath(); ctx.fill()
  // Wing hints
  ctx.strokeStyle = color; ctx.lineWidth = 0.9; ctx.globalAlpha = 0.42
  ctx.beginPath(); ctx.moveTo(cx - sz * 0.32, cy - sz * 0.02)
  ctx.bezierCurveTo(cx - sz * 0.56, cy - sz * 0.18, cx - sz * 0.52, cy + sz * 0.32, cx - sz * 0.28, cy + sz * 0.4); ctx.stroke()
  ctx.beginPath(); ctx.moveTo(cx + sz * 0.32, cy - sz * 0.02)
  ctx.bezierCurveTo(cx + sz * 0.56, cy - sz * 0.18, cx + sz * 0.52, cy + sz * 0.32, cx + sz * 0.28, cy + sz * 0.4); ctx.stroke()
  // Talons perch line
  ctx.globalAlpha = 0.55; ctx.lineWidth = 1
  ctx.beginPath(); ctx.moveTo(cx - sz * 0.35, cy + sz * 0.58); ctx.lineTo(cx + sz * 0.35, cy + sz * 0.58); ctx.stroke()
  ctx.restore()
}
